...
if __name__ == '__main__':
    ...
    for model_criteria in ['auc']:
        ...
        np.save(f'/tmp/{config["task"]}_emb{model_criteria}.npy', all_emb)
        np.save(f'/tmp/{config["task"]}_labels{model_criteria}.npy', all_labels)
        np.save(f'/tmp/{config["task"]}_positioned_labels{model_criteria}.npy',positioned_labels)

        # print('Loading embeddings and labels...')
        # all_emb = np.load(f'/tmp/{config["task"]}_emb{model_criteria}.npy')
        # all_labels = np.load(f'/tmp/{config["task"]}_labels{model_criteria}.npy')
        # positioned_labels = np.load(f'/tmp/{config["task"]}_positioned_labels{model_criteria}.npy')
